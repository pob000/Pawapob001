var wms_layers = [];
        ...
        var lyr_googiemap_0 = new ol.layer.Tile({
            'title': 'googie map',
            //'type': 'base',
            'opacity': 1.000000,
...
lyr_googiemap_0.setVisible(true);lyr_female_cleaned_1.setVisible(true);lyr_male_cleaned_2.setVisible(true);
var layersList = [lyr_googiemap_0,lyr_female_cleaned_1,lyr_male_cleaned_2];
